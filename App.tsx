...
const OpenSpool = () => {
  ...
  const colors = [
    ...
    //{ label: 'Matte Ivory White', value: 'matte_ivory_white', hex: '' },
    //{ label: 'Matte Latte Brown', value: 'matte_latte_brown', hex: '' },
    { label: 'Matte Lilac Purple', value: 'matte_lilac_purple', hex: '8D82C0' },
    { label: 'Matte Ash Grey', value: 'matte_ash_grey', hex: '8D9299' },
    { label: 'Matte Mandarin Orange', value: 'matte_mandarin_orange', hex: 'FAB566' },
    //{ label: 'Matte Sakura Pink', value: 'matte_sakura_pink', hex: '' },
    { label: 'Matte Ice Blue', value: 'matte_ice_blue', hex: 'B7D9E1' },
    { label: 'Matte Marine Blue', value: 'matte_marine_blue', hex: '2397D1' },
    { label: 'Matte Lemon Yellow', value: 'matte_lemon_yellow', hex: 'F9DA85' },
    { label: 'Matte Scarlet Red', value: 'matte_scarlet_red', hex: 'CF4549' },
    { label: 'Matte Dark Red', value: 'matte_dark_red', hex: 'AF3C3C' },
    //{ label: 'Matte Dark Brown', value: 'matte_dark_brown', hex: '' },
    //{ label: 'Matte Dark Green', value: 'matte_dark_green', hex: '' },
    { label: 'Matte Grass Green', value: 'matte_grass_green', hex: '75B269' },
    //{ label: 'Matte Dark Blue', value: 'matte_dark_blue', hex: '' },
    { label: 'Matte Charcoal', value: 'matte_charcoal', hex: '414141' },
    //{ label: 'Matte Desert Tan', value: 'matte_desert_tan', hex: '' },
    //{ label: 'Matte Bone White', value: 'matte_bone_white', hex: '' },
    //{ label: 'Matte Plum', value: 'matte_plum', hex: '' },
    //{ label: 'Matte Sky Blue', value: 'matte_sky_blue', hex: '' },
    //{ label: 'Matte Apple Green', value: 'matte_apple_green', hex: '' },
    //{ label: 'Matte Dark Chocolate', value: 'matte_dark_chocolate', hex: '' },
    //{ label: 'Matte Caramel', value: 'matte_caramel', hex: '' },
    //{ label: 'Matte Terracotta', value: 'matte_terracotta', hex: '' },
    //{ label: 'Matte Nardo Gray', value: 'matte_nardo_gray', hex: '' },
  ];
